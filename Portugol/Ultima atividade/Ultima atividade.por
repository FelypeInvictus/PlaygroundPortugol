programa {
	...
	funcao inicio() {
	    ...
	    faca {
		inteiro escol
		escreva("Digite o codigo correspondente ao produto \n>>")
		leia(escol)
	   ...
	   escreva(estoque)
	    ...
	    escreva("|---------------------------------------------------------------------------------------------------------------|\n")
	            	...
	            	escreva("Você disse não. Logo, a tela não será printada")
	            }
	   ...
	   //Opções de pagamento
	    ...
	    escreva("2. No cartão. Acrescimo 10%\n")
	...
	funcao exibirMenu(){
	    ...
	    escreva("----------------------------------------------------------------------\n")
	    escreva("----------------DIGITE O CODIDO CORRESPONDENTE AO PRODUTO-------------\n")
	    escreva("----------------------------------------------------------------------\n")
	...
	funcao encerramentoLogo(){
	limpa()
		escreva("Compra concluída!\n")
		u.aguarde(2000)
		inteiro imperio = g.carregar_imagem("logo.jpg")
		g.iniciar_modo_grafico(verdadeiro)
		g.definir_dimensoes_janela(1200,1000)
		g.definir_titulo_janela("REALIZADO POR: imperio")
		enquanto(verdadeiro){
			g.desenhar_imagem(0,0,imperio)
			g.renderizar()
		}
